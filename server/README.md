...
```
$ curl http://localhost:8086/placeholder.txt
...
```
$ curl http://localhost:8086/unauthorized
$ # result -> true
```
...
```
$ curl http://localhost:8086/authorized
...
```
$ # POST /auth/login
$ curl -X POST http://localhost:8086/auth/login -d '{"username": "maria", "password": "123"}' -H "Content-Type: application/json"
...
$ curl http://localhost:8086/authorized -H "Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2Vybm..."
$ # result -> {"userId":2}
```
